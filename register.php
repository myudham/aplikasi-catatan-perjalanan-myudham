                                                        ...
                                                        <div class="col-lg-12">
                                                                <div class="p-5">
                                                                        <div class="text-center">
                                                                                <h1 class="h4 text-gray-900 mb-2">Register Akun Di Aplikasi Catatan Perjalanan!</h1>
                                                                        ...
                                                                        <form class="user" method="post" action="proses_register.php">
                                                                                ...
                                                                                <a href="index.php" class="btn btn-facebook btn-user btn-block">
                                                                                        <i class="fa fa-arrow-left fa-fw"></i> Sudah Punya Akun...?> Silahkan Kehalaman Login
                                                                                </a>
                                                                        </form>
                                                                        <hr>
                                                                        <!-- Footer -->
                                                                        ...
                                                                        <div class="container my-auto">
                                                                                <div class="copyright text-center my-auto">
                                                                                        <span>Copyright &copy; Muhammad Yudha M 2022</span>
                                                                                </div>
                                                                        </div>
